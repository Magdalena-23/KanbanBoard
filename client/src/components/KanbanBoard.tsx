    ...
    <div className="min-h-screen bg-purple-50 text-gray-700 flex flex-col">
      ...
      <main className="flex-1 px-4 py-4 overflow-x-auto">
        <div className="flex gap-4 min-w-max">
          ...
          <button className="flex w-64 flex-col items-center justify-center rounded-xl border border-dashed border-purple-300 bg-purple-50 p-4 text-sm font-medium text-purple-700 hover:bg-purple-100 hover:border-purple-400 transition-colors cursor-pointer">
            {columns.length < 1
